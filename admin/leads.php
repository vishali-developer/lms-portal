<?php
// admin/leads.php — Admin Lead Management (Fully Responsive)
    ...
    <form method="GET" id="filterForm">
      <div class="filter-grid mb-2">
        ...
        <div class="d-flex gap-1">
          ...
          <a href="<?= APP_URL ?>/admin/leads.php" class="btn btn-outline-secondary btn-sm px-2">
        ...
        <tbody>
          ...
          <tr>
            <td colspan="10" class="text-center text-muted py-5">
              ...
              No leads found. <a href="<?= APP_URL ?>/admin/leads.php">Clear filters</a>
            </td>
          </tr>
          <?php endif; ?>
        </tbody>
    ...
    <div class="modal-content">
      ...
      <form method="POST" action="<?= APP_URL ?>/api/leads-import.php" enctype="multipart/form-data">
        <div class="modal-body">
          <input type="hidden" name="csrf_token" value="<?= csrfToken() ?>">
          <input type="hidden" name="return_to" value="<?= APP_URL ?>/admin/leads.php">
