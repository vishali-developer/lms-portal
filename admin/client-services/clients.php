<?php
// admin/client-services/clients.php — Admin: Client Services (Grid Card View)
  ...
  <div class="card-body py-2 px-3">
    <form method="GET" class="cs-filter-grid">
      ...
      <div class="d-flex gap-1">
        ...
        <a href="<?= APP_URL ?>/admin/client-services/clients.php" class="btn btn-outline-secondary btn-sm px-2" title="Reset">
...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="<?= APP_URL ?>/admin/client-services/client-form.php" class="btn btn-sm btn-primary">
...
<div class="cs-grid">
  ...
  <div class="cs-card">
    ...
    <div class="cs-card-actions">
      ...
      <a href="<?= APP_URL ?>/admin/client-services/client-form.php?id=<?= $c['id'] ?>"
