<?php
// admin/client-services/client-form.php — Admin: Add / Edit Client
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verifyCsrf($_POST['csrf_token'] ?? '')) {
        ...
        if (!$errors) {
            ...
            redirect(APP_URL . '/admin/client-services/clients.php');
        }
    }
}
  ...
  <div class="col-12 col-xl-9">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="<?= APP_URL ?>/admin/client-services/clients.php" class="btn btn-sm btn-outline-secondary">
        ...
        <form method="POST">
          ...
          <div class="row g-3">
            ...
            <div class="col-12 d-flex gap-2 justify-content-end">
              <a href="<?= APP_URL ?>/admin/client-services/clients.php" class="btn btn-outline-secondary">Cancel</a>
