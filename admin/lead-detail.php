...
$id = (int)($_GET['id'] ?? 0);
if (!$id) { redirect(APP_URL . '/admin/leads.php'); }
...
if (!$lead) { setFlash('danger','Lead not found.'); redirect(APP_URL.'/admin/leads.php'); }
...
<nav aria-label="breadcrumb" class="mb-3">
  <ol class="breadcrumb small">
    <li class="breadcrumb-item"><a href="<?= APP_URL ?>/admin/<?= $listPage ?>">Leads</a></li>
