<?php
// admin/lead-form.php — Add / Edit Lead
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verifyCsrf($_POST['csrf_token'] ?? '')) {
        ...
        if (!$errors) {
            ...
            redirect(APP_URL . '/admin/' . $listPage);
        }
    }
}
  ...
  <div class="col-12 col-xl-9">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="<?= APP_URL ?>/admin/<?= $backListPage ?>" class="btn btn-sm btn-outline-secondary">
        ...
        <form method="POST">
          ...
          <div class="row g-3">
            ...
            <div class="col-12 d-flex gap-2 justify-content-end">
              <a href="<?= APP_URL ?>/admin/<?= $backListPage ?>" class="btn btn-outline-secondary">Cancel</a>
