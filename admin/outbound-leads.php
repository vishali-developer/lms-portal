<?php
// admin/outbound-leads.php — Admin Lead Management: Outbound Leads (Fully Responsive)
...
// ── Build filters ─────────────────────────────────────────────
$where  = ["l.lead_type = 'Outbound Leads'"];
$params = [];
    ...
    <form method="GET" id="filterForm">
      <div class="filter-grid mb-2">
        ...
        <div class="d-flex gap-1">
          ...
          <a href="<?= APP_URL ?>/admin/outbound-leads.php" class="btn btn-outline-secondary btn-sm px-2">
...
<div class="card">
  ...
  <div class="card-header leads-card-header">
    ...
    <span class="leads-title">
      ...
      Outbound Leads <span class="badge bg-primary ms-1"><?= $total ?></span>
    </span>
    ...
    <a href="<?= APP_URL ?>/api/export.php?type=leads&<?= http_build_query(array_merge($_GET, ['lead_type' => 'Outbound Leads'])) ?>"
    ...
    <a href="<?= APP_URL ?>/admin/lead-form.php?lead_type=Outbound+Leads" class="btn btn-sm btn-primary">
        ...
        <tbody>
          ...
          <tr>
            <td colspan="10" class="text-center text-muted py-5">
              ...
              No outbound leads found. <a href="<?= APP_URL ?>/admin/outbound-leads.php">Clear filters</a>
            </td>
          </tr>
          <?php endif; ?>
        </tbody>
...
<div class="modal fade" id="importModal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header border-0 pb-0">
        <h5 class="modal-title"><i class="bi bi-upload text-primary me-2"></i>Import Outbound Leads</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <form method="POST" action="<?= APP_URL ?>/api/leads-import.php" enctype="multipart/form-data">
        <div class="modal-body">
          <input type="hidden" name="csrf_token" value="<?= csrfToken() ?>">
          <input type="hidden" name="return_to" value="<?= APP_URL ?>/admin/outbound-leads.php">
          <input type="hidden" name="lead_type_override" value="Outbound Leads">
          <p class="small text-muted mb-3">
            ...
            Every imported row is tagged <strong>Outbound Leads</strong> automatically.
          </p>
