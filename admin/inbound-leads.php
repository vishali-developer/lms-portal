<?php
// admin/inbound-leads.php — Admin Lead Management: Inbound Leads (Fully Responsive)
require_once __DIR__ . '/../includes/auth.php';
requireRole(['admin','manager']);

$pageTitle  = 'Inbound Leads';
$activePage = 'inbound-leads';

// ── Build filters ─────────────────────────────────────────────
$where  = ["l.lead_type = 'Inbound Leads'"];
$params = [];
    ...
    <form method="GET" id="filterForm">
      <div class="filter-grid mb-2">
        ...
        <div class="d-flex gap-1">
          ...
          <a href="<?= APP_URL ?>/admin/inbound-leads.php" class="btn btn-outline-secondary btn-sm px-2">
...
<div class="card">
  ...
  <div class="card-header leads-card-header">
    ...
    <span class="leads-title">
      ...
      Inbound Leads <span class="badge bg-primary ms-1"><?= $total ?></span>
    </span>
    ...
    <a href="<?= APP_URL ?>/api/export.php?type=leads&<?= http_build_query(array_merge($_GET, ['lead_type' => 'Inbound Leads'])) ?>"
    ...
    <a href="<?= APP_URL ?>/admin/lead-form.php?lead_type=Inbound+Leads" class="btn btn-sm btn-primary">
      ...
      <table class="table table-hover mb-0" id="leadsTable">
        ...
        <tbody>
          ...
          <tr data-id="<?= $lead['id'] ?>"
              ...
              data-edit="<?= APP_URL ?>/admin/lead-form.php?id=<?= $lead['id'] ?>"
          ...
          <tr>
            <td colspan="10" class="text-center text-muted py-5">
              ...
              No inbound leads found. <a href="<?= APP_URL ?>/admin/inbound-leads.php">Clear filters</a>
            </td>
          </tr>
          <?php endif; ?>
        </tbody>
    ...
    <div class="lmc">
      ...
      <div class="lmc-bottom">
        ...
        <div class="lmc-btns">
          ...
          <a href="<?= APP_URL ?>/admin/lead-form.php?id=<?= $lead['id'] ?>"   class="btn btn-xs btn-outline-secondary" title="Edit"><i class="bi bi-pencil"></i></a>
...
<div class="modal fade" id="importModal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header border-0 pb-0">
        <h5 class="modal-title"><i class="bi bi-upload text-primary me-2"></i>Import Inbound Leads</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <form method="POST" action="<?= APP_URL ?>/api/leads-import.php" enctype="multipart/form-data">
        <div class="modal-body">
          <input type="hidden" name="csrf_token" value="<?= csrfToken() ?>">
          <input type="hidden" name="return_to" value="<?= APP_URL ?>/admin/inbound-leads.php">
          <input type="hidden" name="lead_type_override" value="Inbound Leads">
          <p class="small text-muted mb-3">
            Upload a CSV with columns: First Name, Last Name, Phone, Email, Company, Location,
            Service, Lead Source, Status, Priority, Assigned To, Message.
            First Name, Last Name and Phone are required; everything else is optional.
            Every imported row is tagged <strong>Inbound Leads</strong> automatically.
          </p>
