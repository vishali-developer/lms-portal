<?php
// admin/users.php — User Management (Admin & Manager)
  ...
  <div class="card-body py-2 px-3">
    <form method="GET" class="filter-grid">
      ...
      <div class="d-flex gap-1">
        ...
        <a href="<?= APP_URL ?>/admin/users.php" class="btn btn-outline-secondary btn-sm px-2" title="Reset">
...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="<?= APP_URL ?>/admin/user-form.php" class="btn btn-sm btn-primary">
      ...
      <table class="table table-hover mb-0" style="font-size:.84rem;">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="d-flex gap-1">
                <a href="<?= APP_URL ?>/admin/user-form.php?id=<?= $u['id'] ?>"
