...
<nav id="sidebar" class="lms-sidebar">
  ...
  <ul class="sidebar-nav">
    ...
    <li class="nav-item">
      <a href="<?= APP_URL ?>/<?= $role==='employee' ? 'employee' : 'admin' ?>/leads.php"
    ...
    <li class="nav-item">
      <a href="<?= APP_URL ?>/<?= $role==='employee' ? 'employee' : 'admin' ?>/inbound-leads.php"
    ...
    <li class="nav-item">
      <a href="<?= APP_URL ?>/<?= $role==='employee' ? 'employee' : 'admin' ?>/outbound-leads.php"
    ...
    <li class="nav-item">
      <a href="<?= APP_URL ?>/admin/kanban.php"
    ...
    <li class="nav-item">
      <a href="<?= APP_URL ?>/<?= $role==='employee' ? 'employee' : 'admin' ?>/followups.php"
...
<li class="nav-item">
  <a href="<?= APP_URL ?>/<?= $role==='employee' ? 'employee' : 'admin' ?>/employee-report.php"
     class="nav-link <?= ($activePage??'')==='employee-report' ? 'active' : '' ?>">
    <i class="bi bi-person-lines-fill"></i>
    <span><?= $role==='employee' ? 'My Report' : 'Employee Report' ?></span>
  </a>
</li>
    ...
    <li class="nav-item">
      <a href="<?= APP_URL ?>/admin/employees.php"
         class="nav-link <?= ($activePage??'')==='employees' ? 'active' : '' ?>">
