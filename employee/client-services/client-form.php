<?php
// employee/client-services/client-form.php — Employee: Add / Edit Own Client
...
// An employee may only edit a client actually assigned to them
if ($client && (int)$client['account_manager'] !== $uid) {
    setFlash('danger', 'You can only edit clients assigned to you.');
    redirect(APP_URL . '/employee/client-services/clients.php');
}
    ...
    if (!verifyCsrf($_POST['csrf_token'] ?? '')) {
        ...
        if (!$errors) {
            ...
            $dbData = [
                ...
                'status'          => $data['status'],
                'account_manager' => $uid, // always self — never selectable by the employee
            ...
            if ($isEdit) {
                ...
                logActivity($uid, 'Edit Client', "Client #$id '{$dbData['company']}' updated");
                ...
                logActivity($uid, 'Create Client', "Client #$newId '{$dbData['company']}' created");
  ...
  <div class="col-12 col-xl-9">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="<?= APP_URL ?>/employee/client-services/clients.php" class="btn btn-sm btn-outline-secondary">
      ...
      <div class="card-body">
        ...
        <form method="POST">
          ...
          <div class="row g-3">
            ...
            <!-- No Account Manager field: every client an employee creates is auto-assigned to them -->
            <div class="col-12">
              <div class="small text-muted bg-body-secondary rounded p-2">
                <i class="bi bi-info-circle me-1"></i>
                This client will be assigned to <strong>you</strong> automatically.
              </div>
            </div>
            ...
            <div class="col-12 d-flex gap-2 justify-content-end">
              <a href="<?= APP_URL ?>/employee/client-services/clients.php" class="btn btn-outline-secondary">Cancel</a>
