<?php
// employee/inbound-leads.php — Employee: My Assigned Inbound Leads
...
$where  = ['l.assigned_to = ?', "l.lead_type = 'Inbound Leads'"];
$params = [$uid];
  ...
  <div class="card-body py-2">
    <form method="GET" class="row g-2">
      ...
      <div class="col-auto">
        ...
        <a href="<?= APP_URL ?>/employee/inbound-leads.php" class="btn btn-outline-secondary btn-sm">Reset</a>
      </div>
      <div class="col-auto ms-auto">
        <a href="<?= APP_URL ?>/employee/lead-form.php?lead_type=Inbound+Leads" class="btn btn-sm btn-primary">
...
<div class="card">
  <div class="card-header">
    <i class="bi bi-box-arrow-in-down me-2 text-primary"></i>My Inbound Leads
      ...
      <table class="table table-hover mb-0">
        ...
        <tbody>
          ...
          <tr><td colspan="8" class="text-center text-muted py-4">
            <i class="bi bi-inbox display-6 d-block mb-2 opacity-50"></i>No inbound leads assigned.
          </td></tr>
          <?php endif; ?>
        </tbody>
      </table>
