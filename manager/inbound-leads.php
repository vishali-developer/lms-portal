<?php
// manager/inbound-leads.php — Manager: All Inbound Leads
    ...
    <form method="GET" id="filterForm">
      <div class="filter-grid mb-2">
        ...
        <div class="d-flex gap-1">
          ...
          <a href="<?= APP_URL ?>/manager/inbound-leads.php" class="btn btn-outline-secondary btn-sm px-2">
...
<div class="card">
  ...
  <div class="card-header leads-card-header">
    ...
    <a href="<?= APP_URL ?>/manager/lead-form.php?lead_type=Inbound+Leads" class="btn btn-sm btn-primary">
        ...
        <tbody>
          ...
          <tr>
            <td colspan="10" class="text-center text-muted py-5">
              ...
              No inbound leads found. <a href="<?= APP_URL ?>/manager/inbound-leads.php">Clear filters</a>
            </td>
          </tr>
          <?php endif; ?>
        </tbody>
    ...
    <div class="modal-content">
      ...
      <form method="POST" action="<?= APP_URL ?>/api/leads-import.php" enctype="multipart/form-data">
        <div class="modal-body">
          <input type="hidden" name="csrf_token" value="<?= csrfToken() ?>">
          <input type="hidden" name="return_to" value="<?= APP_URL ?>/manager/inbound-leads.php">
