<?php
// manager/user-form.php — Manager: Add / Edit Employee
...
if ($user) {
    if ($selfRole === 'manager' && $user['role'] !== 'employee') {
        ...
        redirect(APP_URL . '/manager/users.php');
    }
  ...
  <div class="col-12 col-xl-8">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="<?= APP_URL ?>/manager/users.php" class="btn btn-sm btn-outline-secondary">
        ...
        <form method="POST">
          ...
          <div class="row g-3">
            ...
            <div class="col-12 d-flex gap-2 justify-content-end mt-2">
              <a href="<?= APP_URL ?>/manager/users.php" class="btn btn-outline-secondary">Cancel</a>
